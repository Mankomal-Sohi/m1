const About=()=>{
    return <div>
    <div className="my-20 mx-12 max-w-full">
    <h2 className="bg-magenta w-fit p-2 text-3xl my-3">About</h2>
    <p className="text-3">As a Computer Science graduate, I bring a dynamic skill set in software development,
    ...
    <div className="h-[3px] bg-gradient-to-r from-[#e310cb] to-[#86fbfb]  w-full "></div>

    <div className="bg-plum py-4">
    <div className="flex flex-col justify-center items-center ">
    <h2 className="bg-magenta w-fit p-2 text-3xl my-2">Education</h2>
    <div className="flex flex-row items-center">
    <img src="https://www.uwinnipeg.ca/foundation/images/UofW_Foundation_Crest_Updated.png" alt="u of w" height="250" width="250" />
            <div className="ml-4">
